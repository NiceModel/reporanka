...
db.execute("CREATE TABLE IF NOT EXISTS Books (id INTEGER PRIMARY KEY, author TEXT, title TEXT, published DATE")
...
def add_book(author, title, published):
    db.execute("INSERT INTO Books (author, title, published) VALUES (?, ?, ?)", [author, title, published])
